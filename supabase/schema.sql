create table if not exists public.meter_readings (
  ...
  cold_water_tariff numeric not null,
  hot_water_tariff numeric not null,
  wastewater_tariff numeric not null,
  electricity_t1_tariff numeric not null,
  electricity_t2_tariff numeric not null,
  electricity_t3_tariff numeric not null,
  delta_cold_water numeric,
  delta_hot_water numeric,
  delta_electricity_t1 numeric,
  delta_electricity_t2 numeric,
  delta_electricity_t3 numeric,
  water_bill numeric,
